...
io.sockets.on('connection', function(socket) {
	socket.on('adduser', function(username) {
        ...
        socket.emit('actorUpdate', actors);
      }
	...
	socket.on('transferControl', function(targetUsername) {
		if (socket.username === activeUserName && usernames[targetUsername] !== null && usernames[targetUsername] !== undefined && userQueue.indexOf(targetUsername) >= 0) {
			grantControl({
